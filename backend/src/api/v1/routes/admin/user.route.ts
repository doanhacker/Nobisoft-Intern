 ...
 *           type: string
 *           format: date
 *         description: Lấy lịch sử từ ngày này, định dạng YYYY-MM-DD, theo múi giờ Asia/Bangkok
 *         example: '2026-07-01'
 *       - in: query
 *         name: toDate
 *         schema:
 *           type: string
 *           format: date
 *         description: Lấy lịch sử đến hết ngày này, định dạng YYYY-MM-DD, theo múi giờ Asia/Bangkok
 *         example: '2026-07-23'
 *     responses:
 *       200:
