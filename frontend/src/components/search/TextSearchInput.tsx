...
export function TextSearchInput({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'flex items-center gap-3 rounded-2xl border bg-background/80 backdrop-blur-sm',
      ...
      >
        ...
        <input
          ...
          className={cn(
            ...
            'text-base outline-none border-none focus:ring-0',
        ...
        <button
          ...
          className={cn(
            'shrink-0 flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold',
